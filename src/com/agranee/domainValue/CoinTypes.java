...
public enum CoinTypes {
    ...
    public static int isValidValue(int value) {
        for (CoinTypes coinType : values()) {
            if (coinType.coinValue == value || value == -1) {
                return value;
            }
        }
    ...
    public static Double coinVolume(int value) {
        for (CoinTypes coinType : values()) {
            if (coinType.coinValue == value) {
                return coinType.getVolume();
            }
        }
        throw new InputMismatchException("");
    }
